...
export const DEFAULT_AREAS = [
  { name: "Kitchen", icon: "🍳", sort_order: 1 },
  { name: "Bathroom", icon: "🛁", sort_order: 2 },
  { name: "Toilet", icon: "🚽", sort_order: 3 },
  { name: "Living Room", icon: "🛋️", sort_order: 4 },
  { name: "Bedroom", icon: "🛌", sort_order: 5 },
  { name: "Entrance", icon: "🚪", sort_order: 6 },
  { name: "Laundry", icon: "🧺", sort_order: 7 },
] as const;
